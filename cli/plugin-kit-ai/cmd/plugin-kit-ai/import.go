...
func init() {
	importCmd.Flags().StringVar(&importFrom, "from", "", `source platform ("claude", "codex-native", "codex-package", "codex-runtime", or "gemini"; omit to auto-detect current native layouts)`)
