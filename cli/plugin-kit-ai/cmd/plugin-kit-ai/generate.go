...
var generateCmd = &cobra.Command{
	...
	Long: `Compile native target artifacts from the package graph discovered via src/plugin.yaml or legacy root plugin.yaml plus the standard authored directories.
