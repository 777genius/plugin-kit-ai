...
Maintainer note: building the checked-in monorepo workspace currently requires Go `1.25.12` for the CLI module and CI lanes. Generated Go plugin projects stay on the public Go SDK path with Go `1.22+`.
## Fast Local Plugin
