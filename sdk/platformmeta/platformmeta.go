	...
	return []PlatformProfile{
		...
		},
		{
			...
			Contract: TargetContractMeta{
				...
				Summary:                "Cursor compiles as a workspace-config lane with repo-local MCP generation, importable user-scope MCP, project rules, and authored Cursor AGENTS content merged into the generated root AGENTS.md boundary file.",
			},
			SDK: SDKMeta{
			...
			Launcher: LauncherMeta{Requirement: LauncherIgnored},
			NativeDocs: []NativeDocSpec{
				{Kind: "agents_markdown", Path: "src/targets/cursor/AGENTS.md", Format: NativeDocMarkdown, Role: NativeDocRoleStructured},
			},
			SurfaceTiers: []SurfaceSupport{
			...
			ManagedArtifacts: []ManagedArtifactSpec{
				...
				{Kind: ManagedArtifactMirror, ComponentKind: "rules", SourceRoot: "src/targets/cursor/rules", OutputRoot: ".cursor/rules"},
			},
			Scaffold: ScaffoldMeta{
				RequiredFiles: []string{
					"src/plugin.yaml",
					"src/README.md",
					"src/targets/cursor/rules/project.mdc",
					"CLAUDE.md",
					"AGENTS.md",
				},
				OptionalFiles: []string{
					"src/targets/cursor/AGENTS.md",
				},
				ForbiddenFiles: []string{
					"launcher.yaml",
				},
				TemplateFiles: []TemplateFile{
					...
					{Path: "src/targets/cursor/rules/project.mdc", Template: "cursor.rule.mdc.tmpl"},
