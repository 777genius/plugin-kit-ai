	...
	return []PlatformProfile{
		...
		},
		{
			...
			Contract: TargetContractMeta{
				...
				TargetComponentKinds:   []string{"rules"},
				Summary:                "Cursor compiles as a workspace-config lane with repo-local MCP, project rules, and a strict documented-subset contract. Root AGENTS.md is reserved for plugin boundary docs, not a Cursor-native surface.",
			},
			SDK: SDKMeta{
