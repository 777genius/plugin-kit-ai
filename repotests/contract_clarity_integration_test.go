...
func TestContractClarity_RuntimeMetadataAndDocsStayAligned(t *testing.T) {
	...
	mustContain(t, string(rootReadme), "brew install plugin-kit-ai/plugin-kit-ai/plugin-kit-ai")
	...
	mustContain(t, string(rootReadme), "The recommended package-manager install path for the `plugin-kit-ai` CLI itself is `brew install plugin-kit-ai/plugin-kit-ai/plugin-kit-ai`")
	...
	mustContain(t, string(cliReadme), "brew install plugin-kit-ai/plugin-kit-ai/plugin-kit-ai")
	...
	mustContain(t, string(supportDoc), "`brew install plugin-kit-ai/plugin-kit-ai/plugin-kit-ai` is the recommended package-manager install path")
	...
	mustContain(t, string(interpretedPromotionDoc), "official downstream CLI availability through Homebrew, `scripts/install.sh`, and `plugin-kit-ai/plugin-kit-ai/setup-plugin-kit-ai@v1`")
	...
	mustContain(t, string(liveWorkflow), "brew tap plugin-kit-ai/plugin-kit-ai")
	mustContain(t, string(liveWorkflow), "brew install plugin-kit-ai/plugin-kit-ai/plugin-kit-ai")
	...
	mustContain(t, string(abiDoc), "the recommended package-manager install path is Homebrew: `brew install plugin-kit-ai/plugin-kit-ai/plugin-kit-ai`")
	mustContain(t, string(abiDoc), "The verified fallback bootstrap path is `scripts/install.sh`, and the official CI setup path is `plugin-kit-ai/plugin-kit-ai/setup-plugin-kit-ai@v1`")
	mustContain(t, string(installCompatibilityDoc), "`brew install plugin-kit-ai/plugin-kit-ai/plugin-kit-ai`")
	mustContain(t, string(installCompatibilityDoc), "`scripts/install.sh`")
	mustContain(t, string(installCompatibilityDoc), "`plugin-kit-ai/plugin-kit-ai/setup-plugin-kit-ai@v1`")
