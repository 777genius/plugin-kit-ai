...
func TestContractClarity_RuntimeMetadataAndDocsStayAligned(t *testing.T) {
	...
	mustContain(t, string(rootReadme), "`plugin-kit-ai` keeps authored source under `plugin/`, still supports legacy `src/` repos, generates the supported outputs you need, and helps you validate the repo before handoff.")
	...
	mustContain(t, string(rootReadme), "choose by job first: [Choose What You Are Building](https://777genius.github.io/plugin-kit-ai/docs/en/guide/choose-what-you-are-building.html)")
	...
	mustContain(t, string(pluginsExamplesReadme), "[cursor-basic](./cursor-basic): Cursor packaged plugin repo with `src/plugin.yaml`, portable `src/skills/**`, generated `.cursor-plugin/plugin.json`, and shared `.mcp.json`")
