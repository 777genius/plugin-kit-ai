...
func TestReleaseSurface_MakefileDocsAndWorkflowsStayAligned(t *testing.T) {
	...
	mustContain(t, liveWorkflow, "echo \"NPM_GLOBAL_ROOT=${root}\" >> \"$GITHUB_ENV\"")
	...
	mustContain(t, liveWorkflow, "node \"${NPM_GLOBAL_ROOT}/plugin-kit-ai/bin/plugin-kit-ai.js\" version")
