...
| Cursor workspace lane | done | Documented Cursor MCP + rules subset now has generate/import/validate coverage, root boundary docs `CLAUDE.md` and `AGENTS.md`, and an explicit deferred-scope boundary for global MCP, nested rules, and JSONC. |
