...
- Gemini now has a scoped `public-beta` Go runtime lane for four hooks and continues hardening inside the package-standard surface without widening the stable runtime promise
