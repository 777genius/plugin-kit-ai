...
```bash
npx --yes universal-agent-plugins@0.1.1 add agent-code-navigator
```
...
```bash
npx --yes universal-agent-plugins@0.1.1 add cloudflare-docs
```
...
```bash
npx --yes universal-agent-plugins@0.1.1 add chrome-devtools
```
