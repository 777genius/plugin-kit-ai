...
function localeLabels(locale) {
  if (locale === "es") {
    return {
      ...
      pythonRuntimeGuide: "Plugin de runtime Python",
      teamReadyPlugin: "Plugin listo para equipos",
      claudePlugin: "Plugin para Claude",
      nodeTypescriptRuntime: "Plugin Node/TypeScript runtime",
      starterTemplates: "Plantillas starter",
      examplesAndRecipes: "Ejemplos y recetas",
      chooseStarterRepo: "Elegir un repositorio inicial",
      chooseDeliveryModel: "Elegir modelo de entrega",
      bundleHandoff: "Transferencia de bundle",
      packageAndWorkspaceTargets: "Paquetes e integración",
  ...
  if (locale === "fr") {
    return {
      ...
      pythonRuntimeGuide: "Plugin runtime Python",
      teamReadyPlugin: "Plugin prêt pour l'équipe",
      claudePlugin: "Plugin pour Claude",
      nodeTypescriptRuntime: "Plugin runtime Node/TypeScript",
      starterTemplates: "Templates starter",
      examplesAndRecipes: "Exemples et recettes",
      chooseStarterRepo: "Choisir un dépôt de démarrage",
      chooseDeliveryModel: "Choisir le modèle de livraison",
      bundleHandoff: "Transfert de bundle",
  ...
  if (locale === "zh") {
    return {
      ...
      firstPlugin: "构建第一个插件",
      pythonRuntimeGuide: "Python 运行时插件",
      teamReadyPlugin: "团队可用插件",
      claudePlugin: "Claude 插件",
      nodeTypescriptRuntime: "Node/TypeScript 运行时插件",
      starterTemplates: "Starter 模板",
      examplesAndRecipes: "示例与实践",
      chooseStarterRepo: "选择入门仓库",
      chooseDeliveryModel: "选择交付模型",
      bundleHandoff: "Bundle 交接",
      packageAndWorkspaceTargets: "包与集成配置",
  ...
  if (locale === "ru") {
    return {
      ...
      pythonRuntimeGuide: "Python runtime-плагин",
      teamReadyPlugin: "Плагин для команды",
      claudePlugin: "Плагин для Claude",
      nodeTypescriptRuntime: "Node/TypeScript runtime-плагин",
