...
- Текущая публичная опорная версия в этом наборе docs - [`v1.1.0`](/ru/releases/v1-1-0).
- Этот релиз усилил проверку lifecycle repo-owned integrations для разных агентов и синхронизировал публичную release-витрину с текущим version contract.
