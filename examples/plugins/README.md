...
- [cursor-basic](./cursor-basic): Cursor packaged plugin repo with `src/plugin.yaml`, portable `src/skills/**`, generated `.cursor-plugin/plugin.json`, and shared `.mcp.json`
