...
- repo-local `.venv`
- `plugin/main.py` importing `plugin_kit_ai_runtime`

This starter begins on the shared package path directly instead of vendoring `plugin/plugin_runtime.py`.
...
- `plugin/main.py`: runtime entry importing `plugin_kit_ai_runtime`
